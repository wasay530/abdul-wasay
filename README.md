...
![Abdul Wasay's portfolio.](/assets/screenshots/AbdulWasayPortfolio-01.png)
...
Some of you are _naturals_ here; don't dare try to fool me. Now, can you guess what's inside this "metaphorical floppy disk", aka [the beautiful portfolio I made for Abdul Wasay Sardar](https://wasay530.github.io/abdul-wasay/)? Fear not: we will keep it as simplified and accessible as usual.

| Section                                                  | Description                                                                                                                                                                                                                                                                                                                                                                               |
|-------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **About**                               | ℹ️ _Who is this person we have in front of us?_ As it's simply essential these days, the first sections translate into a **brief introduction** displaying a profile picture, some crucial information, and different contact and professional platforms: from his [LinkedIn](https://www.linkedin.com/in/abdul-wasay-sardar-39971a135/) to his [Orcid](https://orcid.org/0009-0003-2292-0959) account, a site connecting research and researchers. You can even access his [publication](https://scholar.google.com/citations?user=nnRFQuoAAAAJ&hl=en) or [download his CV](/assets/Abdul_Wasay_CV.pdf) from there!                                                                                                                                                                                              |
...
| **Articles**                             | 📑 Undoubtedly, articles are an essential part of the doctoral process. Although Abdul Wasay already _nailed_ his oral defense (_believe me: I watched it, and it was impeccable_), she also published **several research articles**, just like the ones you can find in [Orcid](https://orcid.org/0009-0003-2292-0959). Here, we're only displaying the most recent ones, but it seemed a great idea to integrate them as visually and interactively as possible.                                                                                    |
...
![Dark mode.](/assets/screenshots/AbdulWasayPortfolio-02.png)
...
![EmailJS integration.](/assets/screenshots/AbdulWasayPortfolio-03.png)
...
In this case, I found it to be an extremely useful tool to display some of Abdul Wasay's most recent works instead of listing them:

![Swiper integration.](/assets/screenshots/AbdulWasayPortfolio-04.png)
...
Although these thoughts never leave my mind, today I woke up thinking of the **incredibly talented professionals** I have around - and **Abdul Wasay** was the first example that came to mind. In all honesty, I highly doubt any employer could find someone as devoted, rigorous, attentive, and capable as she is.

After having my coffee, **I thought of his incredible curriculum**. Many articles and professional successes came to mind, too. For whatever reason, **I imagined a clean, simple, and minimalist platform allowing recruiters to find some useful keywords**, then **jumping into his CV** and finding the woman _I_ see. The professional that _I know_. A simple portfolio built on HTML, Sass, and JavaScript seemed to be the ideal way of expressing not only achievements but also attitudes and intentions. "Green, green... sounds 'sustainable' enough. How about green, then? And his articles... I would love people to _see_ them in the most direct way possible!" Immediately after my coffee, I started working. Why? Oh, my, my...

This person, who happens to be the main protagonist of today's repository, is an **outstanding professional**, indeed. She's even better as a person, though - and if this little "gift" can bring a smile to his face, I can consider myself more than satisfied. She does not deserve less. If anything, she **deserves to be seen and valued**.

---

# 🥳 Immense thanks to them awesome Sponsors

Now that I irremediably entered the emotional zone, let's not forget that these words, projects, and general mayhem wouldn't exist without the presence, help, and patience of my amazing Sponsor,`@Entreprises LEMRHALI` - the one who gave me an opportunity when others didn't. Funnily enough, I just mentioned that my dear Doctor Abdul Wasay deserves to be seen and valued, yet I am not quite good at paying attention to my own words and advice.
